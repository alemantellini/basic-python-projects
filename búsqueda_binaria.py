...
# print(búsqueda_ingenua(mi_lista, 10)) # Salida: 3

def búsqueda_binaria(lista, objetivo, límite_inferior=0, límite_superior=None):
    # Búsqueda binaria de un valor en una lista
...
if __name__ == "__main__":
    # mi_lista = [1, 3, 5, 10, 12]
    # print(búsqueda_binaria(mi_lista, 12)) # Salida: 4
    # Crear una lista ordenada con 10.000 números aleatorios
    tamaño = 10000
